...
namespace TimetableManagementSystem.Sessions
{
    public partial class Sessions : MetroFramework.Forms.MetroForm
    {
        ...
        {
            MySqlCommand cmd = new MySqlCommand("Select * from Sessions", con);
        ...
        public void GetLecturers()
        {
            ...
            MySqlDataAdapter dalecturers = new MySqlDataAdapter(cmd);
        ...
        public void GetTags()
        {
            ...
            MySqlDataAdapter datags = new MySqlDataAdapter(cmd);
        ...
        public void GetGroups()
        {
            ...
            if (cmbSessionTag.Text == "Practical")
            {
                ...
                MySqlDataAdapter dagroups = new MySqlDataAdapter(cmd2);
        ...
        public void GetSubjects()
        {
            ...
            MySqlDataAdapter dasubjects = new MySqlDataAdapter(cmd);
        ...
        private void cmbSessionSubject_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (subject != "")
            {
                ...
                MySqlCommand command = new MySqlCommand("SELECT SubName FROM Subjects Where SubCode = '" + subject + "'", con);
        ...
        private void btnSessionSave_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                MySqlCommand cmd = new MySqlCommand("INSERT INTO Sessions VALUES (@id,@Lecturer, @Subject, @SubjectCode, @Tag, @GroupID, @StudentCount, @Duration)", con);
                cmd.CommandType = CommandType.Text;
        ...
        private void cmbSessionSubjectEdit_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (subjectEdit != "")
            {
                ...
                MySqlCommand command = new MySqlCommand("SELECT SubName FROM Subjects Where SubCode = '" + subjectEdit + "'", con);
        ...
        private void btnSessionUpdate_Click(object sender, EventArgs e)
        {
            if (SID > 0)
            {
                if (IsValidUpdate())
                {
                    MySqlCommand cmd = new MySqlCommand("UPDATE Sessions SET Lecturer = @Lecturer, Subject = @Subject, SubjectCode = @SubjectCode, Tag = @Tag, GroupID = @GroupID, StudentCount = @StudentCount, Duration = @Duration WHERE SessionID = @SID", con);
        ...
        private void btnSessionDelete_Click(object sender, EventArgs e)
        {
            if (SID > 0)
            {
                ...
                {
                    MySqlCommand cmd = new MySqlCommand("DELETE FROM Sessions WHERE SessionID = @SID", con);
                    cmd.CommandType = CommandType.Text;
