    ...
    public partial class Students : MetroFramework.Forms.MetroForm
    {
        ...
        private void yrSemAddBtn_Click(object sender, EventArgs e)
        {
            ...
            if ((yearTxt.Text != string.Empty) && (semTxt.Text != string.Empty))
            {
                ...
                MySqlDataAdapter sda = new MySqlDataAdapter(query1, con);
                ...
                MySqlDataAdapter sda77 = new MySqlDataAdapter(query7, con);
        ...
        private void addPrgBtn_Click(object sender, EventArgs e)
        {
            if ((prgBtn.Text != string.Empty))
            {
                ...
                MySqlDataAdapter sda = new MySqlDataAdapter(query2, con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
        ...
        private void subGrpNumAddBtn_Click(object sender, EventArgs e)
        {
            ...
            if ((subGrpNumTxt.Text != string.Empty))
            {
                ...
                MySqlDataAdapter sda = new MySqlDataAdapter(query4, con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
        ...
        private void yrSemSearchBox_TextChanged(object sender, EventArgs e)
        {
            if (yrSemSrtDrpDwn.Text == "Year")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM YearSemester WHERE Year LIKE '%" + yrSemSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                yrSemData.DataSource = dt;
                con.Close();
            ...
            else if (yrSemSrtDrpDwn.Text == "Semester")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM YearSemester WHERE Semester LIKE '%" + yrSemSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                yrSemData.DataSource = dt;
                con.Close();
            ...
            else if (yrSemSrtDrpDwn.Text == "ID")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM YearSemester WHERE id LIKE '%" + yrSemSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                yrSemData.DataSource = dt;
                con.Close();
        ...
        private void conAddBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd.CommandText = "INSERT INTO GenGroupNumber(GenGrpNum,yearSemRef,programmeRef,GroupNumber) VALUES('" + allItem[0] + "'," + allItem[1] + "," + allItem[2] + "," + allItem[3] + ")";
                cmd.ExecuteNonQuery();
            }
        ...
        private void conSubAddBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd.CommandText = "INSERT INTO GenSubGroupNumber(GenSubGrpNum,GenGroupNumberRef,SubGroupNumberRef) VALUES('" + allItem[0] + "'," + allItem[1] + "," + allItem[2] + ")";
                cmd.ExecuteNonQuery();
            }

            String query6 = "select id,GenSubGrpNum from GenSubGroupNumber";
            MySqlDataAdapter sda = new MySqlDataAdapter(query6, con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
        ...
        private void subGrpNumSearchBox_TextChanged(object sender, EventArgs e)
        {
            if (subGrpNumSrtDrpDwn.Text == "")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM SubGroupNumber WHERE SubGrpNum LIKE '%" + subGrpNumSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                subGrpNumData.DataSource = dt;
                con.Close();
            ...
            else if (subGrpNumSrtDrpDwn.Text == "ID")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM SubGroupNumber WHERE id LIKE '%" + subGrpNumSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                subGrpNumData.DataSource = dt;
                con.Close();
        ...
        private void prgSearchBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (prgSrtDrpDwn.Text == "Programme")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM Programme WHERE Programme LIKE '%" + prgSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                prgData.DataSource = dt;
                con.Close();
            ...
            else if (prgSrtDrpDwn.Text == "ID")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM Programme WHERE id LIKE '%" + prgSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                prgData.DataSource = dt;
                con.Close();
        ...
        private void grpNumSearchBox_TextChanged(object sender, EventArgs e)
        {
            if (grpNumSrtDrpDwn.Text == "Group Number")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM GroupNumber WHERE GrpNum LIKE '%" + grpNumSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                grpNumData.DataSource = dt;
                con.Close();
            ...
            else if (grpNumSrtDrpDwn.Text == "ID")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM GroupNumber WHERE id LIKE '%" + grpNumSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                grpNumData.DataSource = dt;
                con.Close();
        ...
        private void genIdSearchBox_TextChanged(object sender, EventArgs e)
        {
            if (genIdSrtDrpDwn.Text == "")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT id,GenGrpNum FROM GenGroupNumber WHERE GenGrpNum LIKE '%" + genIdSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                genIdData.DataSource = dt;
                con.Close();
            ...
            else if (genIdSrtDrpDwn.Text == "ID")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT id,GenGrpNum FROM GenGroupNumber WHERE id LIKE '%" + genIdSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                genIdData.DataSource = dt;
                con.Close();
        ...
        private void genSubIdSearchBox_TextChanged(object sender, EventArgs e)
        {
            if (genIdSrtDrpDwn.Text == "")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT id,GenSubGrpNum FROM GenSubGroupNumber WHERE GenSubGrpNum LIKE '%" + genSubIdSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                subGrpNumData.DataSource = dt;
                con.Close();
            ...
            else if (genIdSrtDrpDwn.Text == "ID")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT id,GenSubGrpNum FROM GenSubGroupNumber WHERE id LIKE '%" + genSubIdSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                subGrpNumData.DataSource = dt;
                con.Close();
        ...
        private void grpNumEditBtn_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter sda22 = new MySqlDataAdapter(query3, con);
            ...
            MySqlDataAdapter sda33 = new MySqlDataAdapter(query4, con);
