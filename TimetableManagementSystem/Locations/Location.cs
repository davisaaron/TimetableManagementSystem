...
namespace TimetableManagementSystem.Locations
{
...

    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("Select * from locations", con);
        ...
        private void addloc_btn_Click(object sender, EventArgs e)
        {
                ...
                && (roomtype_cmb.Text != string.Empty))
            {
                ...
                cmd.CommandText = "INSERT INTO locations(building,room,capacity,room_type) VALUES ('" + building_cmb.Text + "','" + room_cmb.Text + "'," + capacity_cmb.Value + ",'" + roomtype_cmb.Text + "')";
                cmd.ExecuteNonQuery();
        ...
        private void room_cmb_DropDown(object sender, EventArgs e)
        {
            ...
            //MySqlDataAdapter sda = new MySqlDataAdapter("SELECT room_num from Rooms where building_name ='" + building_cmb.Text + "'", con);
        ...
        private void search_txt_box_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM locations WHERE building LIKE '%" + search_txt_box.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                loc_dgridv.DataSource = dt;
                con.Close();
            ...
            {
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM locations WHERE room LIKE '%" + search_txt_box.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                loc_dgridv.DataSource = dt;
                con.Close();
            ...
            {
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM locations WHERE capacity LIKE '%" + search_txt_box.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                loc_dgridv.DataSource = dt;
                con.Close();
            ...
            {
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM locations WHERE room_type LIKE '%" + search_txt_box.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                loc_dgridv.DataSource = dt;
                con.Close();
