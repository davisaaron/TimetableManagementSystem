...
namespace TimetableManagementSystem.AdvancedOp
{
    public partial class Advanced : MetroFramework.Forms.MetroForm
    {
        ...
        public MySqlConnection con = Config.con;
        ...
        private void noAvaBtn_Click(object sender, EventArgs e)
        {
            if ((typeCmbo.Text != string.Empty) && (itmCmbBox.Text != string.Empty) && (timeCmbBoxStart.Text != string.Empty))
            {
                ...
                if (typeCmbo.Text == "Lecturers")
                {
                    ...
                    cmd.CommandText = "INSERT INTO NotAvailableTime(SelectedType,Item,StartTime,EndTime,Day,GenGroupNumberRef,SubGroupNumberRef,LecturerRef,SessionRef) VALUES ('" + typeCmbo.Text + "','" + itmCmbBox.Text + "','" + timeCmbBoxStart.Text + "','" + timeCmbBoxEnd.Text + "','" + notAvaTimeDateCmb.Text + "',null,null," + ID + ",null)";
                }
                else if (typeCmbo.Text == "Sessions")
                {
                    ...
                    cmd.CommandText = "INSERT INTO NotAvailableTime(SelectedType,Item,StartTime,EndTime,Day,GenGroupNumberRef,SubGroupNumberRef,LecturerRef,SessionRef) VALUES ('" + typeCmbo.Text + "','" + itmCmbBox.Text + "','" + timeCmbBoxStart.Text + "','" + timeCmbBoxEnd.Text + "','" + notAvaTimeDateCmb.Text + "',null,null,null," + ID + ")";
                }
                else if (typeCmbo.Text == "Groups")
                {
                    ...
                    cmd.CommandText = "INSERT INTO NotAvailableTime(SelectedType,Item,StartTime,EndTime,Day,GenGroupNumberRef,SubGroupNumberRef,LecturerRe,SessionRe) VALUES ('" + typeCmbo.Text + "','" + itmCmbBox.Text + "','" + timeCmbBoxStart.Text + "','" + timeCmbBoxEnd.Text + "','" + notAvaTimeDateCmb.Text + "'," + ID + ",null,null,null)";
                }
                else if (typeCmbo.Text == "Sub-Groups")
                {
                    ...
                    cmd.CommandText = "INSERT INTO NotAvailableTime(SelectedType,Item,StartTime,EndTime,GenGroupNumberRef,SubGroupNumberRef,LecturerRef,SessionRef) VALUES ('" + typeCmbo.Text + "','" + itmCmbBox.Text + "','" + timeCmbBoxStart.Text + "','" + timeCmbBoxEnd.Text + "',null," + ID + ",null,null)";
                }
        ...
        private void Advanced_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            MySqlDataAdapter sda3 = new SqlDataAdapter("select * from Sessions", con);
            ...
            */
            ...
            MySqlDataAdapter da3 = new MySqlDataAdapter(query3, con);
            con.Open();
            ...
            MySqlCommand cmd2 = new MySqlCommand(query5, con);
        ...
        private void typeCmbo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (typeCmbo.Text == "Lecturers")
            {
                ...
                MySqlDataAdapter sda = new MySqlDataAdapter("select * from Lecturers", con);
                DataTable dataTable = new DataTable();
                sda.Fill(dataTable);
                foreach (DataRow dataRow in dataTable.Rows)
                {
            ...
            else if (typeCmbo.Text == "Sessions")
            {
                ...
                this.itmCmbBox.DataSource = null;
                itmCmbBox.Items.Clear();
                MySqlDataAdapter sda = new MySqlDataAdapter("select * from Sessions", con);
                DataTable dataTable = new DataTable();
                sda.Fill(dataTable);
                foreach (DataRow dataRow in dataTable.Rows)
                {
            ...
            else if (typeCmbo.Text == "Groups")
            {
                ...
                this.itmCmbBox.DataSource = null;
                itmCmbBox.Items.Clear();
                MySqlDataAdapter sda = new MySqlDataAdapter("select * from GenGroupNumber;", con);
                DataTable dataTable = new DataTable();
                sda.Fill(dataTable);
                foreach (DataRow dataRow in dataTable.Rows)
                {
            ...
            else if (typeCmbo.Text == "Sub-Groups")
            {
                ...
                this.itmCmbBox.DataSource = null;
                itmCmbBox.Items.Clear();
                MySqlDataAdapter sda = new MySqlDataAdapter("select * from GenSubGroupNumber", con);
                DataTable dataTable = new DataTable();
                sda.Fill(dataTable);
                foreach (DataRow dataRow in dataTable.Rows)
                {
        ...
        private void addConBtn_Click(object sender, EventArgs e)
        {
            if ((sesCmb01.Text != string.Empty) && (sesCmb02.Text != string.Empty))
            {
                ...
                cmd.CommandText = "INSERT INTO ConsecutiveSession(Session01,Session02,Session01Ref,Session02Ref) VALUES('" + sesCmb01.Text + "','" + sesCmb02.Text + "'," + ID + "," + ID2 + ")";
        ...
        private void addParBtn_Click(object sender, EventArgs e)
        {
            if ((parSesCmbBox01.Text != string.Empty) && (parSesCmbBox02.Text != string.Empty) && (parSesDurationCmb.Text != string.Empty) && (parSesDayCmb.Text != string.Empty) && (parSesTimeSlotCmbStart.Text != string.Empty))
            {
                ...
                cmd.CommandText = "INSERT INTO ParallelSession(Session01,Session02,Duration,Day,StartTime,EndTime,Session01Ref,Session02Ref) VALUES ('" + parSesCmbBox01.Text + "' ,'" + parSesCmbBox02.Text + "' , " + parSesDurationCmb.Text + " ,'" + parSesDayCmb.Text + "' ,'" + parSesTimeSlotCmbStart.Text + "','" + parSesTimeSlotCmbEnd.Text + "' ," + ID + " ," + ID2 + ")";
        ...
        private void notAvaSearchBox_TextChanged(object sender, EventArgs e)
        {
            if (notAvaSearchDrpDown.Text == "")
            {
                ...
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("select id,SelectedType,Item,TimeSlot from NotAvailableTime where SelectedType LIKE '%" + notAvaSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                notAvaData.DataSource = dt;
                con.Close();
            ...
            if (notAvaSearchDrpDown.Text == "ID")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("select id,SelectedType,Item,TimeSlot from NotAvailableTime where id LIKE '%" + notAvaSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                notAvaData.DataSource = dt;
                con.Close();
            ...
            if (notAvaSearchDrpDown.Text == "Item")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("select id,SelectedType,Item,TimeSlot from NotAvailableTime where Item LIKE '%" + notAvaSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                notAvaData.DataSource = dt;
                con.Close();
            ...
            if (notAvaSearchDrpDown.Text == "Time Slot")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("select id,SelectedType,Item,TimeSlot from NotAvailableTime where TimeSlot LIKE '%" + notAvaSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                notAvaData.DataSource = dt;
                con.Close();
        ...
        private void consecSearchBox_TextChanged(object sender, EventArgs e)
        {
            if (consecSearchDrpDown.Text == "")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("select id,Session01,Session02 from ConsecutiveSession where Session01 LIKE '%" + consecSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
            ...
            if (consecSearchDrpDown.Text == "ID")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("select id,Session01,Session02 from ConsecutiveSession where id LIKE '%" + consecSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                consecData.DataSource = dt;
                con.Close();
            ...
            if (consecSearchDrpDown.Text == "Session02")
            {
                MySqlConnection con = Config.con;
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("select id,Session01,Session02 from ConsecutiveSession where Session02 LIKE '%" + consecSearchBox.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                consecData.DataSource = dt;
                con.Close();
