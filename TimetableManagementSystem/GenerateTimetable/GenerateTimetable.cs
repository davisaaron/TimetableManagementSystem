...
namespace TimetableManagementSystem.GenerateTimetable
{
    public partial class GenerateTimetable : MetroFramework.Forms.MetroForm
    {
        ...
        private void GenerateTimetable_Load(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter da4 = new MySqlDataAdapter(query4, con);
            con.Open();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            var wsDt = pck.Workbook.Worksheets.Add("Supplier_Data");

            //Load the datatable and set the number formats...
            wsDt.Cells["A1"].LoadFromDataTable(dt, true);

            wsDt.Cells[1, 1, 1, dt.Columns.Count].Merge = true;
            wsDt.Cells[1, 10, dt.Rows.Count + 1, 20].Style.Numberformat.Format = "#,##0";
            wsDt.Cells[2, 3, dt.Rows.Count + 1, 4].Style.Numberformat.Format = "mm-dd-yy";
            wsDt.Cells[wsDt.Dimension.Address].AutoFitColumns();

          
            var fi = new FileInfo(@"C:\Users\PC\Documents\execel\SupplierDetails.xlsx");
            pck.SaveAs(fi);
