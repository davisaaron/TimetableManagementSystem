...
namespace TimetableManagementSystem.Rooms
{
    public partial class Rooms : MetroFramework.Forms.MetroForm
    {
        ...
        private void tagroom_cmb_DropDown(object sender, EventArgs e)
        {
            ...
            //MySqlCommand MySqlcmd = new MySqlCommand("select * from Rooms", con);
            //con.Open();
            ...
            MySqlDataAdapter sda = new MySqlDataAdapter("select * from Rooms", con);
            DataTable dataTable = new DataTable();
            sda.Fill(dataTable);
            foreach (DataRow dataRow in dataTable.Rows)
            {
        ...
        private void allocate_tag_btn_Click(object sender, EventArgs e)
        {
            ...
            if ((tag_cmb.Text != string.Empty) && (tagroom_cmb.Text != string.Empty))
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("Select Tag, Room from Tag_Rooms where Tag = '" + tag_cmb.Text + "' and Room = '" + tagroom_cmb.Text + "' ", con);
                ...
                else
                {
                    ...
                    cmd.CommandText = "INSERT INTO Tag_Rooms (Tag,Room) VALUES ('" + tag_cmb.Text + "','" + tagroom_cmb.Text + "')";
                    cmd.ExecuteNonQuery();
        ...
        {
            sub_cmb.Items.Clear();
            MySqlDataAdapter sda = new MySqlDataAdapter("select SubName from Subjects ", con);
            DataTable dataTable = new DataTable();
            sda.Fill(dataTable);
            foreach (DataRow dataRow in dataTable.Rows)
            {
        ...
        private void allocatetagsub_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                //check duplicate before save
                MySqlDataAdapter da = new MySqlDataAdapter("Select Subject, Tag, Room from SubjectTag_Rooms where Subject = '" + sub_cmb.Text + "'and (Tag = '" + tagsub_cmb.Text + "'  and Room = '" + tagsub_room_cmb.Text + "')", con);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
                {
                ...
                else
                {
                    ...
                    MySqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "INSERT INTO SubjectTag_Rooms(Subject,Tag,Room) VALUES ('" + sub_cmb.Text + "','" + tagsub_cmb.Text + "','" + tagsub_room_cmb.Text + "' )";
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Room Allocated!");
                    con.Close();
        ...
        private void lecturer_cmb_DropDown(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter sda = new MySqlDataAdapter("select LecName from Lecturers ", con);
            DataTable dataTable = new DataTable();
            sda.Fill(dataTable);
            foreach (DataRow dataRow in dataTable.Rows)
            {
        ...
        private void allocatelecturer_room_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                //check duplicate before save
                MySqlDataAdapter da = new MySqlDataAdapter("Select LecturerName, Room from Lecturer_Rooms where LecturerName = '" + lecturer_cmb.Text + "' and  Room = '" + lecroom_cmb.Text + "'", con);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
                {
                ...
                else
                {
                    ...
                    MySqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "INSERT INTO Lecturer_Rooms(LecturerName,Room) VALUES ('" + lecturer_cmb.Text + "','" + lecroom_cmb.Text + "' )";
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Room Allocated!");
                    con.Close();
        ...
        private void session_cmb_DropDown(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter sda = new MySqlDataAdapter("select SessionID,Lecturer,Subject,Tag from Sessions ", con);
            DataTable dataTable = new DataTable();
            sda.Fill(dataTable);
            foreach (DataRow dataRow in dataTable.Rows)
            {
        ...
        private void allocatesession_room_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                //check duplicate before save
                MySqlDataAdapter da = new MySqlDataAdapter("Select SessionID, Room from Session_Rooms where SessionID = '" + session_cmb.Text + "' and  Room = '" + session_room_cmb.Text + "'", con);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
                {
                ...
                else
                {
                    ...
                    MySqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "INSERT INTO Session_Rooms(SessionID,Room) VALUES ('" + session_cmb.Text + "','" + session_room_cmb.Text + "' )";
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Room Allocated!");
                    con.Close();
        ...
        private void session1_cmb_DropDown(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter sda = new MySqlDataAdapter("select id,Session01, Session02 from ConsecutiveSession ", con);
            DataTable dataTable = new DataTable();
            sda.Fill(dataTable);
            foreach (DataRow dataRow in dataTable.Rows)
            {
        ...
        private void allocateroomconsecsession_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                //check duplicate before save
                MySqlDataAdapter da = new MySqlDataAdapter("Select Room,ConsecutiveSessionId from ConsecutiveSession_Rooms where Room = '" + consec_room_cmb.Text + "' and  ConsecutiveSessionId = '" + session1_cmb.Text + "'", con);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
                {
                ...
                else
                {
                    ...
                    MySqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "INSERT INTO ConsecutiveSession_Rooms(Room,ConsecutiveSessionId) VALUES ('" + consec_room_cmb.Text + "', '" + session1_cmb.Text + "')";
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Room Allocated!");
                    con.Close();
        ...
        private void timeslot_cmb_DropDown(object sender, EventArgs e)
        {
            ...
            //    MySqlDataAdapter sda = new SqlDataAdapter("select TimeSlot from WorkingTimeSlot", con);
            //    DataTable dataTable = new DataTable();
            //    sda.Fill(dataTable);
            //    foreach (DataRow dataRow in dataTable.Rows)
            //    {
        ...
        private void non_reserv_room_time_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                //check duplicate before save
                MySqlDataAdapter da = new MySqlDataAdapter("Select Room, Day,StartTime,EndTime from NonReservableTime_Rooms where Room = '" + non_res_room_cmb.Text + "' " +
                ...
                else
                {
                    ...
                    MySqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "INSERT INTO NonReservableTime_Rooms(Room,Day,StartTime,EndTime) VALUES ('" + non_res_room_cmb.Text + "','" + day_cmb.Text + "','" + starttime_cmb.Text + "','" + endtime_cmb.Text + "'   )";
                    cmd.ExecuteNonQuery();
        ...
        {
            grp_cmb.Items.Clear();
            MySqlDataAdapter sda = new MySqlDataAdapter("select GenGrpNum from GenGroupNumber", con);
            DataTable dataTable = new DataTable();
            sda.Fill(dataTable);
            foreach (DataRow dataRow in dataTable.Rows)
            {
        ...
        {
            MySqlDataAdapter sda = new MySqlDataAdapter("SELECT s.GenSubGrpNum from GenSubGroupNumber s, GenGroupNumber g" +
        ...
        private void grpallocateroom_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                //check duplicate before save
                MySqlDataAdapter da = new MySqlDataAdapter("Select GroupNum, SubGroupNum, Room from GroupSubGroup_Rooms" +
                ...
                else
                {
                    ...
                    MySqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "INSERT INTO GroupSubGroup_Rooms(GroupNum,SubGroupNum,Room) " +
