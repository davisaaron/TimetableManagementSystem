...
namespace TimetableManagementSystem.Lecturers
{
    public partial class AddLecturer : MetroFramework.Forms.MetroForm
    {
        ...
        {
            MySqlCommand cmd = new MySqlCommand("Select * from Lecturers", con);
        ...
        private void btnLecSave_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                MySqlCommand cmd = new MySqlCommand("INSERT INTO Lecturers VALUES (@id,@lecname, @lecfaculty, @lecdepartment, @leccenter, @lecbuilding, @leclevel, @lecrank)", con);
                ...
                MySqlCommand command = new MySqlCommand("SELECT LecturerID FROM Lecturers ORDER BY 1 DESC", con);
                ...
                MySqlCommand command2 = new MySqlCommand("UPDATE Lecturers SET LecRank = @LecRank Where LecturerID = @LecturerID ", con);
        ...
        private bool IsValid()
        {
            ...
            {
                txtlableChan.Visible = true;
                txtlableChan.ForeColor = Color.Red;
                txtlableChan.Text = "Please enter the Lecture Name !";
                txtLecName.Focus();
                return false;
            ...
            {
                txtlableChan.Visible = false;

            }
            if (string.IsNullOrEmpty(cmbLecFac.Text))
            {
                txtlableChan.Visible = true;
                txtlableChan.ForeColor = Color.Red;
                txtlableChan.Text = "Please Selecct the Faculity !";
                txtLecName.Focus();
                return false;
            ...
            if (string.IsNullOrEmpty(cmbLecDepartment.Text))
            {
                txtlableChan.Visible = true;
                txtlableChan.ForeColor = Color.Red;
                txtlableChan.Text = "Please Selecct the Department !";
                cmbLecDepartment.Focus();
                return false;
            ...
            if (string.IsNullOrEmpty(cmbLecCenter.Text))
            {
                txtlableChan.Visible = true;
                txtlableChan.ForeColor = Color.Red;
                txtlableChan.Text = "Please Selecct the Center !";
                cmbLecCenter.Focus();
                return false;
            ...
            if (string.IsNullOrEmpty(cmbLecBuilding.Text))
            {
                txtlableChan.Visible = true;
                txtlableChan.ForeColor = Color.Red;
                txtlableChan.Text = "Please Selecct the Building !";
                cmbLecBuilding.Focus();
                return false;
            ...
            if (string.IsNullOrEmpty(cmbLecLevel.Text))
            {
                txtlableChan.Visible = true;
                txtlableChan.ForeColor = Color.Red;
                txtlableChan.Text = "Please Selecct the Lecture Level !";
                cmbLecLevel.Focus();
                return false;
        ...
        private void btnLecUpdate_Click(object sender, EventArgs e)
        {
            if (LecturerID > 0)
            {
                if (IsValidUpdate())
                {
                    MySqlCommand cmd = new MySqlCommand("UPDATE Lecturers SET LecName = @LecName, LecFaculty = @LecFaculty, LecDepartment = @LecDepartment, LecCenter = @LecCenter, LecBuilding = @LecBuilding, LecLevel = @LecLevel, LecRank = @LecRank WHERE LecturerID = @LecturerID", con);
                    cmd.CommandType = CommandType.Text;
        ...
        private void btnLecDelete_Click(object sender, EventArgs e)
        {
            if (LecturerID > 0)
            {
                ...
                {
                    MySqlCommand cmd = new MySqlCommand("DELETE FROM Lecturers WHERE LecturerID = @LecturerID", con);
                    cmd.CommandType = CommandType.Text;
        ...
        private void txtLecSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (txtLecSearch.Text != "")
            {
                ...
                con.Open();
                MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM Lecturers WHERE LecName LIKE '%" + txtLecSearch.Text + "%'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                dgvLectures.DataSource = dt;
                con.Close();
...
this.Close();
        ...
        private void cmbLecBuilding_SelectedIndexChanged(object sender, EventArgs e)
        {
