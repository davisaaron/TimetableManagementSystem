...
namespace TimetableManagementSystem.Statistics
{
    public partial class Statistics : MetroFramework.Forms.MetroForm
    {
        ...
        private void LoadLecFacChart()
        {
            ...
            con.Open();
            MySqlDataAdapter adapt = new MySqlDataAdapter("Select LecFaculty,COUNT(LecturerID) as c from Lecturers GROUP BY LecFaculty", con);
        ...
        private void LoadLecDeptChart()
        {
            ...
            DataSet ds = new DataSet();
            con.Open();
            MySqlDataAdapter adapt = new MySqlDataAdapter("Select LecDepartment,COUNT(LecturerID) as countlec from Lecturers GROUP BY LecDepartment", con);
        ...
        private void LoadProgrammeStdGroupChart()
        {
            ...
            DataSet ds = new DataSet();
            con.Open();
            MySqlDataAdapter adapt = new MySqlDataAdapter("select p.Programme as Programme, count(g.GenGrpNum) as Grpcount  from Programme p, GenGroupNumber g where p.id = g.programmeRef group by p.Programme", con);
        ...
        private void LoadSubjectYearChart()
        {
            ...
            DataSet ds = new DataSet();
            con.Open();
            MySqlDataAdapter adapt = new MySqlDataAdapter("Select SubYear,COUNT(SubCode) as subyrcount from Subjects GROUP BY SubYear", con);
